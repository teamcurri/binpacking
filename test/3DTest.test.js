...
const { Item, Bin, Packer } = BinPacking
...
const testDatas = [
  {
    ...
    expectation: function (packer) {
      return packer.bins[0].items.length === 1 && packer.unfitItems.length === 0
    },
  },
  {
  ...
  },
  {
    ...
    expectation: function (packer) {
      return packer.bins[0].items.length === 7 && packer.unfitItems.length === 0
    },
  },
  {
    ...
    expectation: function (packer) {
      return packer.bins[0].items.length === 1 && packer.unfitItems.length === 2
    },
  },
  {
  ...
  },
  {
    ...
    expectation: function (packer) {
      return packer.bins[0].items.length === 2 && packer.unfitItems.length === 0
    },
  },
  {
